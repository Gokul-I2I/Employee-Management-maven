...
public interface DepartmentService {
     ...
     * @throws MyException
     */
    Department createDepartment(String departmentName) throws MyException;
     ...
     * @throws MyException
     */
    boolean isDepartmentIdPresent(int departmentId) throws MyException;
     ...
     * @throws MyException
     */
    Department retrieveDepartment(int departmentId) throws MyException;
     ...
     * @throws MyException
     */
    boolean deleteDepartment(int id) throws MyException;
     ...
     * @throws MyException
     */
    void updateDepartmentName(String departmentName, int departmentId) throws MyException;
}